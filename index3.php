                    ...
                    <div id="contact-form">
                                        ...
                                        <form  action="./connection2.php" method="post" >
                                            <div class="input-wrap">
                                                ...
                                                <input name="user" type="text" id="user"  class="inputForm2" ></div>
                                            <div class="input-wrap"><input name="pass" type="text" id="pass"  ></div>
                                            ...
                                            <button  class="bt1" type="submit"  value="upload"   ><span>Login </span></button> 
