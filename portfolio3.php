...
$query = $db->query("SELECT * FROM image  WHERE ID=44");
...
<a href="portfolio2.php"  ><img src="<?php echo $imageURL1; ?>" alt="" height="20%" width="20%" style="padding: 10px;"/></i></a>
<a href="portfolio32.php"  ><img src="<?php echo $imageURL2; ?>" alt="" height="20%" width="20%" style="padding: 10px;"/></i></a>
<a href="portfolio32.php"  ><img src="<?php echo $imageURL3; ?>"alt="" height="20%" width="20%" style="padding: 10px;"/></i></a>
<a href="portfolio31.php"  ><img src="<?php echo $imageURL4; ?>"alt="" height="20%" width="20%" style="padding: 10px;"/></i></a>
<a href="portfolio2.php"  ><img src="<?php echo $imageURL5; ?>"alt="" height="20%" width="20%" style="padding: 10px;"/></i></a>
<a href="portfolio32.php"  ><img src="<?php echo $imageURL6; ?>" alt=""alt="" height="20%" width="20%" style="padding: 10px;"/></i></a>
