...
$query = $db->query("SELECT * FROM image WHERE ID=47");
...
<img src="<?php echo $imageURL1; ?>" alt="" height="20%" width="20%" style="padding: 10px;"/>
<img src="<?php echo $imageURL2; ?>" alt="" height="20%" width="20%" style="padding: 10px;"/>
<img src="<?php echo $imageURL3; ?>"alt="" height="20%" width="20%" style="padding: 10px;"/>
<img src="<?php echo $imageURL4; ?>"alt="" height="20%" width="20%" style="padding: 10px;"/>
<img src="<?php echo $imageURL5; ?>"alt="" height="20%" width="20%" style="padding: 10px;"/>
<img src="<?php echo $imageURL6; ?>" alt=""alt="" height="20%" width="20%" style="padding: 10px;"/>
